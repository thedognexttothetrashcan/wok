        ...
        if (catalog == 'province') {
            ...
            $.getJSON("{{ url_for('static', filename='json/geometryProvince/') }}" + getProId(param) + '.js', function (geoJson) {
                    ...
                    myChart_china.on('click', function (params) {
                        ...
                        {
                            // window.location.href = `{{ url_for('new_old_pow.t3_index1') }}?param=${new Base64().encode(params.name)}&catalog=city&code=${getCityId(geoJson, params.name)}`;
            ...
            $.getJSON("{{ url_for('static', filename='json/geometryCouties/') }}" + getProId(params.name) + '.js', function (geoJson) {
        ...
        myChart_china.on('click', function (params) {
            ...
            $.getJSON("/static/json/geometryProvince/" + getProId(name) + '.js', function (geoJson) {
                ...
                myChart_china1.on('click', function (params) {
                    ...
                    // console.log(getCityId(geoJson, params))
