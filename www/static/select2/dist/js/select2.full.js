  ...
  function InitSelection (decorated, $element, options) {
    if (options.get('debug') && window.console && console.warn) {
      console.warn(
        ...
        ' of a custom source_data adapter that overrides the `current` method. ' +
  ...
  function Query (decorated, $element, options) {
    if (options.get('debug') && window.console && console.warn) {
      console.warn(
        ...
        'custom source_data adapter that overrides the `query` method. Support ' +
...
(function (factory) {
    ...
    var special = $.event.special.mousewheel = {
        ...
        teardown: function() {
            ...
            // Clean up the source_data we added to the element
